...
The second is to create a Watchface project by way of the Zeus CLI, in the same way as developing an Mini Program, see [Quick Start](../guides/quick-start.md).
