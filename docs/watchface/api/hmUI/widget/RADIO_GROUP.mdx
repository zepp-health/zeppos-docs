...
| Properties | Description                                                              | Required | Type     |
| ---------- | ------------------------------------------------------------------------ | -------- | -------- |
| x          | The x-coordinate of the component. Coordinates relative to `radioGroup`. | YES      | `number` |
| y          | The y-coordinate of the component. Coordinates relative to `radioGroup`. | YES      | `number` |
| w          | Width of the component.                                                  | YES      | `number` |
| h          | The height of the component.                                             | YES      | `number` |
...
| --------------------- | --------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `hmUI.prop.INIT`      | set             | `object`                           | Initialize the component and set the default selected items.                                                                               |
...
:::tip
Please refer to [Design Resources](../../../../reference//design-resources.mdx) for the image resources in the code example
:::
