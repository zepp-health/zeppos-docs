...
| text_x           | Text box displays location x coordinates                                                                                | NO       | `number`  |
| text_y           | Text box displays position y coordinates                                                                                | NO       | `number`  |
| text_w           | Text box width                                                                                                          | NO       | `number`  |
| text_h           | Text box height                                                                                                         | NO       | `number`  |
| sub_text_x       | Subtext box displays position x coordinates                                                                             | NO       | `number`  |
| sub_text_y       | Subtext box displays position y coordinates                                                                             | NO       | `number`  |
