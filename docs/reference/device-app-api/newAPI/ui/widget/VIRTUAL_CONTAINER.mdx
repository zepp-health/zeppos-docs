...
| -------- | ----------------------------------------------- | -------- | -------- | --------- |
| x        | Widget x coordinate, default `0`                | No       | `number` | 4.0       |
| y        | Widget y coordinate, default `0`                | No       | `number` | 4.0       |
| w        | Widget width, default screen width              | No       | `number` | 4.0       |
| h        | Widget height, default screen height            | No       | `number` | 4.0       |
| layout   | Layout properties for Flex layout configuration | No       | `object` | 4.0       |
