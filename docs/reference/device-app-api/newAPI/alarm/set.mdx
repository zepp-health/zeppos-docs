...
| file            | <code>string</code>  | Y        | -                  | File path to wake up Mini Program, supporting App Service                                                                                                                                                                                                                             | 3.0       |
| time            | <code>number</code>  | N        | -                  | Timer execution time, UTC timestamp, in seconds, this field has higher priority than `delay`                                                                                                                                                                                          | 3.0       |
| delay           | <code>number</code>  | N        | -                  | How many seconds of delay based on the current time after the execution, in seconds                                                                                                                                                                                                   | 3.0       |
