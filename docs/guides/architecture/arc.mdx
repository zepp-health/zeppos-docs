...
![Architecture Diagram](/img/docs/guides/architecture/architecture-en.jpg)
...
"Device App" run on the device side (devices with Zepp OS) and have the ability to interact with UI, device sensor calls, etc.
...
- Communication between the Device Application and the Side Service via Bluetooth
  - Device Application using the [`Bluetooth Communication`](../../guides/best-practice/bluetooth-communication.mdx)
  - Side App using the [`Messaging API`](../../reference/side-service-api/messaging.mdx)
