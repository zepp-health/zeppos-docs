...
1. There is a difference in the design of the application icon
2. No need to manually select the application category, all are "Workout Extension Categories".
...
![icon_standard](/img/design/extension_icon.png)
...
![icon_standard](/img/design/extension_store.png)
