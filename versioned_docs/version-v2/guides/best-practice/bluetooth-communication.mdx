...
sidebar_label: Bluetooth Communication
---
...
The "Device App" uses Bluetooth capabilities through the [`ble` API](../../reference/device-app-api/newAPI/ble.mdx) and the "Side Service" uses Bluetooth capabilities through the `Messaging API`, both of which can currently only manipulate binary data and are cumbersome for developers to organize data structures.
