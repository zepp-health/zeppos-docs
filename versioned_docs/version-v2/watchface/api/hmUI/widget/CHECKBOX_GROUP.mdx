...
| ---------- | -------- | -------- | ------------------------------------------------------------------------ |
| x          | YES      | `number` | The x-coordinate of components. Coordinates relative to `checkboxGroup`. |
| y          | YES      | `number` | The y-coordinate of components. Coordinates relative to `checkboxGroup`. |
