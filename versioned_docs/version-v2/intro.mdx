...
Here, follow the documentation to quickly build Mini Programs and Watchfaces for Zepp OS powered devices such as Amazfit GTR 4, Amazfit GTS4.
...
:::tip
Zepp OS 2.1 is newly released, click to learn more [Zepp OS 2.1 New Features](./guides/version-info/new-features-21.md)
:::
