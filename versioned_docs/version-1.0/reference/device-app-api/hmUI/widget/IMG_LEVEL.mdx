...
| w            | The width of the widget.(optional)  | NO | `number` |
| h            | The height of the widget.(optional) | NO | `number` |
| level        | Picture drawn [0-image_length]         | NO | `number` |

-If one of w / h is not written, it will go to image_array to read the width and height of the image as the width and height of the widget.
