...
sidebar_label: SYSTEM_KEYBOARD 系统键盘
---
...
| 值               | 说明         | API_LEVEL |
| ---------------- | ------------ | --------- |
| inputType.EMOJI  | Emoji 表情   | 4.0       |
| inputType.NUM    | 数字键盘     | 4.0       |
| inputType.CHAR   | 字符键盘     | 4.0       |
| inputType.VOICE  | 语音输入     | 4.0       |
| inputType.JSKB   | 自定义键盘 Widget | 4.2       |
