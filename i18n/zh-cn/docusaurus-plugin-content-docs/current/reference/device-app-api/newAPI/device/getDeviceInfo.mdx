...
| bleAddr      | <code>string</code>  | BLE 地址                     | 3.6       |
| btAddr       | <code>string</code>  | 蓝牙地址                     | 3.6       |
| wifiAddr     | <code>string</code>  | Wi-Fi 地址                   | 3.6       |
| barHeight    | <code>string</code>  | 方形屏幕设备状态栏高度       | 3.6       |
| hasNFC       | <code>boolean</code> | 设备是否支持 NFC             | 4.0       |
| hasMic       | <code>boolean</code> | 设备是否支持麦克风           | 4.0       |
| hasCrown     | <code>boolean</code> | 设备是否支持表冠             | 4.0       |
| hasBuzzer    | <code>boolean</code> | 设备是否支持振动器           | 4.0       |
| hasSpeaker   | <code>boolean</code> | 设备是否支持扬声器           | 4.0       |
| uuid         | <code>string</code>  | 设备唯一标识，长度 32 字节   | 4.2       |
