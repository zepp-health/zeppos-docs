...
1. 简化可编辑组件表单配置，仅保留必要配置项
1. 优化可编辑组件预览，添加编辑模式预览

---

### V4.9.0 (2026 年 06 月 02 日)

#### 🚀 新增

1. 制作 Zepp OS 表盘新增 HybridCharge、乳酸阈心率、乳酸阈配速、睡眠时长、海拔高度、完全恢复时间、HRV、爬楼、月升、月落、月跑次数 共 11 个数据项
